...
// LOSPCP prescale register settings, normally it will be set to default values
   ...
   SysCtrlRegs.LOSPCP.all = 0x0000;	// 0 Low speed clock = SYSCLKOUT/1

// XCLKOUT to SYSCLKOUT ratio.  By default XCLKOUT = 1/4 SYSCLKOUT
   SysCtrlRegs.XCLK.bit.XCLKOUTDIV = 2; // 2 XCLKOUT = SYSCLKOUT
...
// This function is not written to be an example of efficient code.
   ...
   SysCtrlRegs.PCLKCR0.bit.ECANAENCLK = 1;    // eCAN-A		SYSCLKOUT/2
   ...
   SysCtrlRegs.PCLKCR0.bit.LINAENCLK = 1;     // LIN-A		SYSCLKOUT/2
